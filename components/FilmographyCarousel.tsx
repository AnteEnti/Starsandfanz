...
const FilmographyCarousel: React.FC<FilmographyCarouselProps> = ({ movies }) => {
  ...
  return (
    <div className="relative group">
      ...
      >
        {movies.map(movie => (
          <div key={movie.id} className="flex-shrink-0 w-36 group">
            ...
            <div className="mt-2 text-center">
              <h5 className="text-sm font-semibold text-white truncate group-hover:text-rose-300">{movie.title}</h5>
