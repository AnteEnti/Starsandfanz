...
const navItems: ({ id: AdminView; label: string; icon: string; isSubItem?: boolean } | { type: 'heading', label: string })[] = [
  ...
  { id: 'api_keys', label: 'API Keys', icon: 'vpn_key' },
  ...
  { id: 'analytics_user_growth', label: 'User Growth', icon: 'trending_up', isSubItem: true },
